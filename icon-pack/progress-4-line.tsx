...
Icon.displayName = 'Progress4Line'

/**
 * Remix Icon: Progress 4 Line
 * @see {@link https://remixicon.com/icon/progress-4-line Remix Icon Docs}
 */
export const Progress4Line = memo(Icon)
