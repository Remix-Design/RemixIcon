...
Icon.displayName = 'HotelBedLine'

/**
 * Remix Icon: Hotel Bed Line
 * @see {@link https://remixicon.com/icon/hotel-bed-line Remix Icon Docs}
 */
export const HotelBedLine = memo(Icon)
