...
Icon.displayName = 'BarChartBoxAiFill'

/**
 * Remix Icon: Bar Chart Box Ai Fill
 * @see {@link https://remixicon.com/icon/bar-chart-box-ai-fill Remix Icon Docs}
 */
export const BarChartBoxAiFill = memo(Icon)
