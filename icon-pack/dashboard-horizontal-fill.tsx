...
Icon.displayName = 'DashboardHorizontalFill'

/**
 * Remix Icon: Dashboard Horizontal Fill
 * @see {@link https://remixicon.com/icon/dashboard-horizontal-fill Remix Icon Docs}
 */
export const DashboardHorizontalFill = memo(Icon)
