...
Icon.displayName = 'TrafficLightLine'

/**
 * Remix Icon: Traffic Light Line
 * @see {@link https://remixicon.com/icon/traffic-light-line Remix Icon Docs}
 */
export const TrafficLightLine = memo(Icon)
