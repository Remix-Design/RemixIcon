...
Icon.displayName = 'BookmarkLine'

/**
 * Remix Icon: Bookmark Line
 * @see {@link https://remixicon.com/icon/bookmark-line Remix Icon Docs}
 */
export const BookmarkLine = memo(Icon)
