...
Icon.displayName = 'BilliardsLine'

/**
 * Remix Icon: Billiards Line
 * @see {@link https://remixicon.com/icon/billiards-line Remix Icon Docs}
 */
export const BilliardsLine = memo(Icon)
