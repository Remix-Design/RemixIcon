...
Icon.displayName = 'ArrowRightDoubleFill'

/**
 * Remix Icon: Arrow Right Double Fill
 * @see {@link https://remixicon.com/icon/arrow-right-double-fill Remix Icon Docs}
 */
export const ArrowRightDoubleFill = memo(Icon)
