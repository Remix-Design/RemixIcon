...
Icon.displayName = 'AccountPinBoxLine'

/**
 * Remix Icon: Account Pin Box Line
 * @see {@link https://remixicon.com/icon/account-pin-box-line Remix Icon Docs}
 */
export const AccountPinBoxLine = memo(Icon)
