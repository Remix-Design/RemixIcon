...
Icon.displayName = 'TrafficLightFill'

/**
 * Remix Icon: Traffic Light Fill
 * @see {@link https://remixicon.com/icon/traffic-light-fill Remix Icon Docs}
 */
export const TrafficLightFill = memo(Icon)
