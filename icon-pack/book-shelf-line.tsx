...
Icon.displayName = 'BookShelfLine'

/**
 * Remix Icon: Book Shelf Line
 * @see {@link https://remixicon.com/icon/book-shelf-line Remix Icon Docs}
 */
export const BookShelfLine = memo(Icon)
