...
Icon.displayName = 'VolumeUpLine'

/**
 * Remix Icon: Volume Up Line
 * @see {@link https://remixicon.com/icon/volume-up-line Remix Icon Docs}
 */
export const VolumeUpLine = memo(Icon)
