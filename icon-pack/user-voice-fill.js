...
Icon.displayName = 'UserVoiceFill'

/**
 * Remix Icon: User Voice Fill
 * @see {@link https://remixicon.com/icon/user-voice-fill Remix Icon Docs}
 */
export const UserVoiceFill = memo(Icon)
