...
Icon.displayName = 'FileWord2Line'

/**
 * Remix Icon: File Word 2 Line
 * @see {@link https://remixicon.com/icon/file-word-2-line Remix Icon Docs}
 */
export const FileWord2Line = memo(Icon)
