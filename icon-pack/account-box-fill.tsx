...
Icon.displayName = 'AccountBoxFill'

/**
 * Remix Icon: Account Box Fill
 * @see {@link https://remixicon.com/icon/account-box-fill Remix Icon Docs}
 */
export const AccountBoxFill = memo(Icon)
