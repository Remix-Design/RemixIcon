...
Icon.displayName = 'Message3Line'

/**
 * Remix Icon: Message 3 Line
 * @see {@link https://remixicon.com/icon/message-3-line Remix Icon Docs}
 */
export const Message3Line = memo(Icon)
