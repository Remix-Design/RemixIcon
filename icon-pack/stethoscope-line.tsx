...
Icon.displayName = 'StethoscopeLine'

/**
 * Remix Icon: Stethoscope Line
 * @see {@link https://remixicon.com/icon/stethoscope-line Remix Icon Docs}
 */
export const StethoscopeLine = memo(Icon)
