...
Icon.displayName = 'Contrast2Line'

/**
 * Remix Icon: Contrast 2 Line
 * @see {@link https://remixicon.com/icon/contrast-2-line Remix Icon Docs}
 */
export const Contrast2Line = memo(Icon)
