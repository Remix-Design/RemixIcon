...
Icon.displayName = 'ImageAddLine'

/**
 * Remix Icon: Image Add Line
 * @see {@link https://remixicon.com/icon/image-add-line Remix Icon Docs}
 */
export const ImageAddLine = memo(Icon)
