...
Icon.displayName = 'Progress2Line'

/**
 * Remix Icon: Progress 2 Line
 * @see {@link https://remixicon.com/icon/progress-2-line Remix Icon Docs}
 */
export const Progress2Line = memo(Icon)
