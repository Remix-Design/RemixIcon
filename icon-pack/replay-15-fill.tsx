...
Icon.displayName = 'Replay15Fill'

/**
 * Remix Icon: Replay 15 Fill
 * @see {@link https://remixicon.com/icon/replay-15-fill Remix Icon Docs}
 */
export const Replay15Fill = memo(Icon)
