...
Icon.displayName = 'AccountPinBoxFill'

/**
 * Remix Icon: Account Pin Box Fill
 * @see {@link https://remixicon.com/icon/account-pin-box-fill Remix Icon Docs}
 */
export const AccountPinBoxFill = memo(Icon)
