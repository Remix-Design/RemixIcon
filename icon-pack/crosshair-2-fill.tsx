...
Icon.displayName = 'Crosshair2Fill'

/**
 * Remix Icon: Crosshair 2 Fill
 * @see {@link https://remixicon.com/icon/crosshair-2-fill Remix Icon Docs}
 */
export const Crosshair2Fill = memo(Icon)
