...
Icon.displayName = 'InfinityLine'

/**
 * Remix Icon: Infinity Line
 * @see {@link https://remixicon.com/icon/infinity-line Remix Icon Docs}
 */
export const InfinityLine = memo(Icon)
