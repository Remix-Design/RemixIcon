...
Icon.displayName = 'ImageEditLine'

/**
 * Remix Icon: Image Edit Line
 * @see {@link https://remixicon.com/icon/image-edit-line Remix Icon Docs}
 */
export const ImageEditLine = memo(Icon)
