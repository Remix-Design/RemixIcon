...
Icon.displayName = 'StarHalfSLine'

/**
 * Remix Icon: Star Half S Line
 * @see {@link https://remixicon.com/icon/star-half-s-line Remix Icon Docs}
 */
export const StarHalfSLine = memo(Icon)
