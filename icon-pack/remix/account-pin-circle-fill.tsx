...
Icon.displayName = 'AccountPinCircleFill'

/**
 * Remix Icon: Account Pin Circle Fill
 * @see {@link https://remixicon.com/icon/account-pin-circle-fill Remix Icon Docs}
 */
export const AccountPinCircleFill = memo(Icon)
