...
Icon.displayName = 'UserLocationLine'

/**
 * Remix Icon: User Location Line
 * @see {@link https://remixicon.com/icon/user-location-line Remix Icon Docs}
 */
export const UserLocationLine = memo(Icon)
