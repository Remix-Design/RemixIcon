...
Icon.displayName = 'ShoppingBasket2Line'

/**
 * Remix Icon: Shopping Basket 2 Line
 * @see {@link https://remixicon.com/icon/shopping-basket-2-line Remix Icon Docs}
 */
export const ShoppingBasket2Line = memo(Icon)
