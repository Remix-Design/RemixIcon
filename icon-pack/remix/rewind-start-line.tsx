...
Icon.displayName = 'RewindStartLine'

/**
 * Remix Icon: Rewind Start Line
 * @see {@link https://remixicon.com/icon/rewind-start-line Remix Icon Docs}
 */
export const RewindStartLine = memo(Icon)
