...
Icon.displayName = 'SnowflakeLine'

/**
 * Remix Icon: Snowflake Line
 * @see {@link https://remixicon.com/icon/snowflake-line Remix Icon Docs}
 */
export const SnowflakeLine = memo(Icon)
