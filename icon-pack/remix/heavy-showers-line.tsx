...
Icon.displayName = 'HeavyShowersLine'

/**
 * Remix Icon: Heavy Showers Line
 * @see {@link https://remixicon.com/icon/heavy-showers-line Remix Icon Docs}
 */
export const HeavyShowersLine = memo(Icon)
