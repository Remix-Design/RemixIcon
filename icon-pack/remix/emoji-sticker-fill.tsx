...
Icon.displayName = 'EmojiStickerFill'

/**
 * Remix Icon: Emoji Sticker Fill
 * @see {@link https://remixicon.com/icon/emoji-sticker-fill Remix Icon Docs}
 */
export const EmojiStickerFill = memo(Icon)
