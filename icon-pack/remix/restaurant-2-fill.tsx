...
Icon.displayName = 'Restaurant2Fill'

/**
 * Remix Icon: Restaurant 2 Fill
 * @see {@link https://remixicon.com/icon/restaurant-2-fill Remix Icon Docs}
 */
export const Restaurant2Fill = memo(Icon)
