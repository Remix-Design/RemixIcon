...
Icon.displayName = 'ArmchairLine'

/**
 * Remix Icon: Armchair Line
 * @see {@link https://remixicon.com/icon/armchair-line Remix Icon Docs}
 */
export const ArmchairLine = memo(Icon)
