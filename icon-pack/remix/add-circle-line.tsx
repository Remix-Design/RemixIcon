...
Icon.displayName = 'AddCircleLine'

/**
 * Remix Icon: Add Circle Line
 * @see {@link https://remixicon.com/icon/add-circle-line Remix Icon Docs}
 */
export const AddCircleLine = memo(Icon)
