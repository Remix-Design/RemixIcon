...
Icon.displayName = 'BookMarkedLine'

/**
 * Remix Icon: Book Marked Line
 * @see {@link https://remixicon.com/icon/book-marked-line Remix Icon Docs}
 */
export const BookMarkedLine = memo(Icon)
