...
Icon.displayName = 'AiGenerateText'

/**
 * Remix Icon: Ai Generate Text
 * @see {@link https://remixicon.com/icon/ai-generate-text Remix Icon Docs}
 */
export const AiGenerateText = memo(Icon)
