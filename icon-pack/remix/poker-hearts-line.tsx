...
Icon.displayName = 'PokerHeartsLine'

/**
 * Remix Icon: Poker Hearts Line
 * @see {@link https://remixicon.com/icon/poker-hearts-line Remix Icon Docs}
 */
export const PokerHeartsLine = memo(Icon)
