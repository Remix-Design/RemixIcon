...
Icon.displayName = 'ShoppingBasket2Fill'

/**
 * Remix Icon: Shopping Basket 2 Fill
 * @see {@link https://remixicon.com/icon/shopping-basket-2-fill Remix Icon Docs}
 */
export const ShoppingBasket2Fill = memo(Icon)
