...
Icon.displayName = 'MailLockFill'

/**
 * Remix Icon: Mail Lock Fill
 * @see {@link https://remixicon.com/icon/mail-lock-fill Remix Icon Docs}
 */
export const MailLockFill = memo(Icon)
