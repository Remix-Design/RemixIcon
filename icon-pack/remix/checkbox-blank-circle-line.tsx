...
Icon.displayName = 'CheckboxBlankCircleLine'

/**
 * Remix Icon: Checkbox Blank Circle Line
 * @see {@link https://remixicon.com/icon/checkbox-blank-circle-line Remix Icon Docs}
 */
export const CheckboxBlankCircleLine = memo(Icon)
