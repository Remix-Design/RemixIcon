...
Icon.displayName = 'AccountCircleFill'

/**
 * Remix Icon: Account Circle Fill
 * @see {@link https://remixicon.com/icon/account-circle-fill Remix Icon Docs}
 */
export const AccountCircleFill = memo(Icon)
