...
Icon.displayName = 'PassPendingLine'

/**
 * Remix Icon: Pass Pending Line
 * @see {@link https://remixicon.com/icon/pass-pending-line Remix Icon Docs}
 */
export const PassPendingLine = memo(Icon)
