...
Icon.displayName = 'SteeringFill'

/**
 * Remix Icon: Steering Fill
 * @see {@link https://remixicon.com/icon/steering-fill Remix Icon Docs}
 */
export const SteeringFill = memo(Icon)
