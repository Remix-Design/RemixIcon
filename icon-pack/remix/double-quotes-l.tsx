...
Icon.displayName = 'DoubleQuotesL'

/**
 * Remix Icon: Double Quotes L
 * @see {@link https://remixicon.com/icon/double-quotes-l Remix Icon Docs}
 */
export const DoubleQuotesL = memo(Icon)
