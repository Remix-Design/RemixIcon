...
Icon.displayName = 'CriminalLine'

/**
 * Remix Icon: Criminal Line
 * @see {@link https://remixicon.com/icon/criminal-line Remix Icon Docs}
 */
export const CriminalLine = memo(Icon)
