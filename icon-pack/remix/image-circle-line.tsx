...
Icon.displayName = 'ImageCircleLine'

/**
 * Remix Icon: Image Circle Line
 * @see {@link https://remixicon.com/icon/image-circle-line Remix Icon Docs}
 */
export const ImageCircleLine = memo(Icon)
