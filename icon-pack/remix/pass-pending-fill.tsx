...
Icon.displayName = 'PassPendingFill'

/**
 * Remix Icon: Pass Pending Fill
 * @see {@link https://remixicon.com/icon/pass-pending-fill Remix Icon Docs}
 */
export const PassPendingFill = memo(Icon)
