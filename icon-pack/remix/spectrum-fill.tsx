...
Icon.displayName = 'SpectrumFill'

/**
 * Remix Icon: Spectrum Fill
 * @see {@link https://remixicon.com/icon/spectrum-fill Remix Icon Docs}
 */
export const SpectrumFill = memo(Icon)
