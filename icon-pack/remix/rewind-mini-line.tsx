...
Icon.displayName = 'RewindMiniLine'

/**
 * Remix Icon: Rewind Mini Line
 * @see {@link https://remixicon.com/icon/rewind-mini-line Remix Icon Docs}
 */
export const RewindMiniLine = memo(Icon)
