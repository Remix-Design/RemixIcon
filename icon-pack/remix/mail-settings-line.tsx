...
Icon.displayName = 'MailSettingsLine'

/**
 * Remix Icon: Mail Settings Line
 * @see {@link https://remixicon.com/icon/mail-settings-line Remix Icon Docs}
 */
export const MailSettingsLine = memo(Icon)
