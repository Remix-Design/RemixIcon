...
Icon.displayName = 'FacebookBoxLine'

/**
 * Remix Icon: Facebook Box Line
 * @see {@link https://remixicon.com/icon/facebook-box-line Remix Icon Docs}
 */
export const FacebookBoxLine = memo(Icon)
