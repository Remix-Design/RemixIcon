...
Icon.displayName = 'SecurePaymentLine'

/**
 * Remix Icon: Secure Payment Line
 * @see {@link https://remixicon.com/icon/secure-payment-line Remix Icon Docs}
 */
export const SecurePaymentLine = memo(Icon)
