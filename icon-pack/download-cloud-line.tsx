...
Icon.displayName = 'DownloadCloudLine'

/**
 * Remix Icon: Download Cloud Line
 * @see {@link https://remixicon.com/icon/download-cloud-line Remix Icon Docs}
 */
export const DownloadCloudLine = memo(Icon)
