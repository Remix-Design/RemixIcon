...
Icon.displayName = 'HeartPulseLine'

/**
 * Remix Icon: Heart Pulse Line
 * @see {@link https://remixicon.com/icon/heart-pulse-line Remix Icon Docs}
 */
export const HeartPulseLine = memo(Icon)
