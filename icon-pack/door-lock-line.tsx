...
Icon.displayName = 'DoorLockLine'

/**
 * Remix Icon: Door Lock Line
 * @see {@link https://remixicon.com/icon/door-lock-line Remix Icon Docs}
 */
export const DoorLockLine = memo(Icon)
