    ...
    <Svg viewBox="0 0 40 40" fill={color} height={size} width={size} {...otherProps}>
      <G clipPath="url(#clip0_51_1013)">
        ...
        <Path
          ...
          fill={color}
        />
        <Path d="M9.56543 20H11.3046V26.9565H9.56543V20Z" fill={color} />
        <Path d="M2.6084 20H4.34754V26.9565H2.6084V20Z" fill={color} />
        <Path
        ...
        <Path
          ...
          fill={color}
        />
        <Path d="M5.2168 25.2175H8.69508V26.9567H5.2168V25.2175Z" fill={color} />
        <Path d="M5.2168 18.261H8.69508V20.0001H5.2168V18.261Z" fill={color} />
        <Path
