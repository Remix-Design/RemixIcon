  ...
  return (
    <Svg viewBox="0 0 40 40" fill={color} height={size} width={size} {...otherProps}>
      <G clipPath="url(#clip0_51_560)">
        ...
        />
        <Path
          d="M20 39.9999C31.0456 39.9999 40 31.0456 40 19.9999C40 17.5535 39.56 15.21 38.756 13.0435H1.24398C0.440078 15.21 0 17.5535 0 19.9999C0 31.0456 8.95437 39.9999 20 39.9999Z"
          fill={color}
        />
        <Path
        ...
        />
        <Path
          d="M6.91016 11.3044V21.2815C6.91016 21.9477 7.05813 22.5769 7.35125 23.1669H17.819C18.1121 22.577 18.2601 21.9477 18.2601 21.2815V11.3044H6.91016Z"
          fill={color}
        />
        <Path
          d="M16.0639 18.2608H13.4553V16.5217H15.1945V14.7825H13.4553V13.0435H11.7162V14.7825H9.97711V16.5217H11.7162V18.2608H9.10742V19.9999H11.7162V21.7391H13.4553V19.9999H16.0639V18.2608Z"
          fill={color}
        />
        <Path
          d="M9.72367 25.5945C10.8444 26.2988 11.9958 26.7078 12.5852 26.8896C13.1747 26.7078 14.3261 26.2988 15.4468 25.5945C16.577 24.8842 17.3692 24.0719 17.8191 23.1668C17.3229 22.8158 16.7175 22.6088 16.0635 22.6088C15.8254 22.6088 15.5941 22.637 15.3716 22.6888C14.9003 21.6178 13.8304 20.8696 12.5853 20.8696C11.3402 20.8696 10.2702 21.6178 9.79898 22.6888C9.57656 22.637 9.34516 22.6088 9.10711 22.6088C8.45312 22.6088 7.84773 22.8158 7.35156 23.1668C7.80117 24.0718 8.59344 24.8842 9.72367 25.5945Z"
          fill={color}
        />
      </G>
      <Defs>
