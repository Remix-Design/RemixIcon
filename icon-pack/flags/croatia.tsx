    ...
    <Svg viewBox="0 0 40 40" fill="none" height={size} width={size} {...otherProps}>
      <G clipPath="url(#clip0_51_1812)">
        ...
        <Path
          ...
          fill="#F0F0F0"
        />
        <Path d="M13.043 13.0435H15.8255V15.826H13.043V13.0435Z" fill="#D80027" />
        <Path d="M18.6084 13.0435H21.391V15.826H18.6084V13.0435Z" fill="#D80027" />
        <Path d="M24.1729 13.0435H26.9554V15.826H24.1729V13.0435Z" fill="#D80027" />
        <Path d="M15.8252 15.8259H18.6078V18.6085H15.8252V15.8259Z" fill="#D80027" />
        <Path d="M21.3906 15.8259H24.1732V18.6085H21.3906V15.8259Z" fill="#D80027" />
        <Path d="M13.043 18.6077H15.8255V21.3902H13.043V18.6077Z" fill="#D80027" />
        <Path d="M15.8252 21.3904H18.6078V24.173H15.8252V21.3904Z" fill="#D80027" />
        <Path d="M18.6084 18.6077H21.391V21.3902H18.6084V18.6077Z" fill="#D80027" />
        <Path d="M24.1729 18.6077H26.9554V21.3902H24.1729V18.6077Z" fill="#D80027" />
        <Path d="M21.3906 21.3904H24.1732V24.173H21.3906V21.3904Z" fill="#D80027" />
        <Path d="M18.6084 24.1731H21.391V26.9557H18.6084V24.1731Z" fill="#D80027" />
        <Path
