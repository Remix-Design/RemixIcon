...
Icon.displayName = 'TimerFlashFill'

/**
 * Remix Icon: Timer Flash Fill
 * @see {@link https://remixicon.com/icon/timer-flash-fill Remix Icon Docs}
 */
export const TimerFlashFill = memo(Icon)
