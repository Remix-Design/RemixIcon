...
Icon.displayName = 'VolumeUpFill'

/**
 * Remix Icon: Volume Up Fill
 * @see {@link https://remixicon.com/icon/volume-up-fill Remix Icon Docs}
 */
export const VolumeUpFill = memo(Icon)
