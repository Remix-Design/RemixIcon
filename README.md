...
#### Download Manually
Download [`remixicon.css`](http://cdn.remixicon.com/releases/v1.1.1/remixicon.css) file, add it to the &lt;head&gt; tag of your html document.
...
Download [`remixicon.symbol.svg`](http://cdn.remixicon.com/releases/v1.1.1/remixicon.symbol.svg) file into your project directory，use icons with the `<use>` element, such as:
